<template>
    <div class="md:w-1/2 text-center relative" v-motion-roll-visible-once-top>
        <div
            ...
            <div class="mt-5 text-xl font-sans font-bold text-[#00FFA3]">
                24 hrs National Level Hackathon
            </div>
            <div class="flex flex-col justify-center items-center mt-5 first-letter:font-sans text-palette-400">
